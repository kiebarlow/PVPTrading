        ...
        <div className='min-h-screen bg-[#0D0D0D] text-white p-8 flex flex-col justify-center items-center'>
            ...
            <div className='flex space-x-6 mb-8'>
                <button
                    ...
                    ${depositPageSelected ? 'bg-green-600' : 'bg-[#333333]'} hover:bg-green-700`}
                >
                    Deposit
                </button>
                <button
            ...
            {depositPageSelected ? (
                <div className='text-center'>
                    ...
                    <div className='bg-[#1A1A1A] p-6 rounded-lg'>
                        <p className='text-sm opacity-70 mb-4'>Send your funds to the following address:</p>
                ...
                <div className='text-center'>
                    ...
                    <div className='bg-[#1A1A1A] p-6 rounded-lg'>
                        <p className='text-sm opacity-70 mb-4'>Enter your Solana address and the number of gems to withdraw:</p>
